...
sera toujours pratiquée dans le bas de la baignoire dans la face cachée pour les tuyauteries. </p><a name="positionnement"></a>
			...
			<p>
				...
				<a style="cursor: pointer" id="toggler" onclick="showme('entreeSortie', this.id);" >Information</a>
				<p id="entreeSortie" style="display:none;"><strong>Entrée</strong></br>
					...
					<br><strong>Evacuation</strong><br>
	...
	<p><a style="cursor: pointer" id="toggler" onclick="showme('bainaremous', this.id);" >Information</a></p><div id="bainaremous" style="display:none;">

	<strong>Système de massage à l’air</strong><br>
	Le système à air fonctionne sur base d’un jet, réglable, d’air soufflé par des becs insérés dans les parois de la baignoire ou du tonneau.
	<p><a style="cursor: pointer" id="toggler" onclick="showme('air', this.id);" >Information</a></p><p id="air" style="display:none;">Ce système est aussi nommé système Spa ou système Air Jet. L’intensité du souffle d’air est réglée par des boutons insérés dans le raccord au mur. L’air est compressé dans un souffleur spécialisé pour bain à remous, avant d’être injecté dans l’eau pour vous masser de la tête aux pieds. 
	Informations techniques du souffleur : 230 V, 0,7 kW à 1,3 kW</p>
	<br><strong>Système jet-massage</strong><br>
	Ce système fonctionne sur base de 2 (ou plus) becs installés au niveau du dos qui éjectent un jet d’eau afin de vous masser.
	<p><a style="cursor: pointer" id="toggler" onclick="showme('jet', this.id);" >Information</a></p><p id="jet" style="display:none;">Ce dispositif est également appelé système : hydro, Venturi, airjet ou jacuzzi. Il combine un flot d’eau pompé de l’eau de bain avec un flot d’air selon le principe Venturi. L’eau est pompée par une pompe spécialisée pour bain à remous. La quantité du flot d’air, directement réglable sur le raccord au mur, influence la concentration du jet : diffus ou ponctuel. Le système de base est le système Jet 1. Un élément de chauffe peut être installé sur le circuit de pompe afin de garder l’eau projetée à température. Ce système est le système Jet 2. Le système Jet 2 ST est équipé d’une écumoire afin de pomper l’eau en surface. 
	Informations techniques de la pompe (additionnellement) : 230 V, 0,55 kW à 1,5 kW</p><br>
	...
	<br><br><a style="cursor: pointer" id="toggler" onclick="showme('massageAir', this.id);" ><strong>Système de massage à l’air</strong></a><p id="massageAir" style="display:none;">Le système à air fonctionne sur base d’un jet, réglable, d’air soufflé par des becs insérés dans les parois de la baignoire ou du tonneau.<br>Ce système est aussi nommé système Spa ou système Air Jet. L’intensité du souffle d’air est réglée par des boutons insérés dans le raccord au mur. L’air est compressé dans un souffleur spécialisé pour bain à remous, avant d’être injecté dans l’eau pour vous masser de la tête aux pieds. 
	Informations techniques du souffleur : 230 V, 0,7 kW à 1,3 kW</p>
	<br>
	<a style="cursor: pointer" id="toggler" onclick="showme('massageJet', this.id);" ><strong>Système jet-massage</strong></a><p id="massageJet" style="display:none;">Ce système fonctionne sur base de 2 (ou plus) becs installés au niveau du dos qui éjectent un jet d’eau afin de vous masser.<br>Ce dispositif est également appelé système : hydro, Venturi, airjet ou jacuzzi. Il combine un flot d’eau pompé de l’eau de bain avec un flot d’air selon le principe Venturi. L’eau est pompée par une pompe spécialisée pour bain à remous. La quantité du flot d’air, directement réglable sur le raccord au mur, influence la concentration du jet : diffus ou ponctuel. Le système de base est le système Jet 1. Un élément de chauffe peut être installé sur le circuit de pompe afin de garder l’eau projetée à température. Ce système est le système Jet 2. Le système Jet 2 ST est équipé d’une écumoire afin de pomper l’eau en surface. 
...
<p><a style="cursor: pointer" id="toggler" onclick="showme('accessoires', this.id);" >Information</a></p><p id="accessoires" style="display:none;">
<strong>Marches</strong><br>
Les bains et tonneaux de 1m de hauteur ou plus peuvent être livrés avec des marches jusqu’à une hauteur de 50 cm sous le bord. La largeur et profondeur totale de l’escalier extérieur est de également 50 cm. A l’intérieur du produit se trouve une marche intégrée afin de faciliter l’entrée dans l’eau.
<br><strong>Assise</strong><br>
...
<br><strong>Dossiers</strong><br>
Nous pouvons intégrer un ou plusieurs dossiers dans votre baignoire. Nos dossiers classiques en bois existent sous format intégré ou amovible, selon vos désirs. Le dossier classique vous soutient à gauche et à droite de votre colonne vertébrale, ce qui permet une circulation idéale de l’eau autour de votre corps. Ce dispositif, quoiqu’il a l’air moins confortable que les formes compliquées soi-disant ergonomiques, s’adapte parfaitement à de nombreuses positions et est parfaitement confortable grâce à la pression de l’eau. 
<br><strong>Repose-pieds</strong><br>
Afin de vous permettre de vous installer plus confortablement seul dans votre grande baignoire, ou d’accommoder des personnes de tailles variables, nous fabriquons également des repose-pieds amovibles. Ils vous permettent de réguler facilement la longueur confortable de votre baignoire.
<br><strong>Tablette</strong><br>
Une planche en bois massif assorti à votre baignoire vous servira de tablette traversant la largeur du bain. Quelle meilleure solution pour déposer une tasse de thé, un livre ou tout autre objet que vous désirez avoir à portée de main ?
<br><strong>Tapis de bain</strong><br>
Nos tapis de bain fabriqués dans le même bois que votre baignoire, tonneau ou douche crée l’endroit parfait où se sécher après s’être détendu.
</p>


<a style="cursor: pointer" id="toggler" onclick="showme('marches', this.id);" ><strong>Marches</strong></a>
...
<a style="cursor: pointer" id="toggler" onclick="showme('assise', this.id);" ><strong>Assises</strong></a>
...
<a style="cursor: pointer" id="toggler" onclick="showme('dossiers', this.id);" ><strong>Dossiers</strong></a>
...
<a style="cursor: pointer" id="toggler" onclick="showme('reposePieds', this.id);" ><strong>Repose pieds</strong></a>
...
<a style="cursor: pointer" id="toggler" onclick="showme('tablette', this.id);" ><strong>Tablettes</strong></a>
...
<a style="cursor: pointer" id="toggler" onclick="showme('tapis', this.id);" ><strong>Tapis de douche</strong></a>
