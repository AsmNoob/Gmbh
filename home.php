...
<body>
	...
	<div id="page-wrapper">
		...
		<!--<p> &nbsp;&nbsp;&nbsp;&nbsp;Bain moussant 760€ &nbsp;&nbsp;&nbsp;&nbsp;<a href="panier.php?action=ajout&amp;l=bain&amp;q=moussant&amp;p=162x62" onclick="window.open(this.href, '', 
			'toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=yes, copyhistory=no, width=600, height=350'); return false;">Ajouter au panier</a></p>q
			<br>
			<br>
...
<!-- 
				...
				{
					echo "Need wheelchair access.";foreach ($_SESSION['listeProduits'] as $item) {echo $item." ";}; $_SESSION['listeProduits'][] ='Need';print_r($_SESSION['listeProduits']);
					echo "lol";
				}
				else
				{
				...
				<section class="wrapper style2">
					...
					<p><strong>Chez Blumenberg nous nous sommes associés au matériel agréable qu’est le bois depuis plus de 100 ans dans la fabrication de produits dérivés de tonneaux. Depuis des dizaines d’années nous fournissons à peu près tous les grands fabricants et vendeurs du secteur des saunas avec nos produits de qualité appréciés comme tels.</strong></p>
					<p><a  style="cursor: pointer" id="toggler" onclick="showme('bois', this.id);" >Information</a></p>
					<p id="bois" style="display:none;">Nous ne connaissons pas d’autre fabriquant, qui produit en quantité et qualité similaire des baignoires, tonneaux de plongeon ou de baignade et bains à remous en bois massif. Dans notre atelier plein de tradition nous disposons de toute la flexibilité nécessaire pour, à part notre service de livraison standard, fort apprécié, nous adapter aux souhaits particuliers de nos clients.</p>
				...
				<section class="wrapper style2">
					...
					<p><strong>Chacun de ces produits est produit avec le plus grand soin pour garantir leur qualité. La production de votre produit est suivie individuellement de la conception à la fabrication afin de vous garantir le résultat le plus adapté possible.</strong></p>
					<!-- </div>
				</section>
