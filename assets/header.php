	...
	<!-- Nav -->
		<nav id="nav">
			<ul>
				...
				<li><a href="lavabos.php">Lavabos</a>
					<ul>
						<li><a href="lavabos.php#">Dimensions et forme</a></li>
						<li><a href="lavabos.php#">Pied</a></li>
						<li><a href="lavabos.php#">Raccords aux installations</a></li>
					</ul>
				</li>
				<li><a href="accessoires.php">Accessoires de Sauna</a>
					<ul>
						<li><a href="accessoires.php#">Seaux</a></li>
						<li><a href="accessoires.php#">Douches de cascade</a></li>
					</ul>
				</li>
				<li><a href="applications.php">Applications extérieures</a>
					<ul>
						<li><a href="applications.php#">Vernis UV</a></li>
						<li><a href="applications.php#">Chauffage</a></li>
						<li><a href="applications.php#">Tonneaux de pluie</a></li>
